      ...
      <div class="container" style="padding-left: 0px; padding-right: 0px;">
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	     		<a id="_logo"  href="<%=basePath%>" style="color:#fff; font-size: 24px;" class="navbar-brand hidden-sm">资源授权管理系统</a>
			...
			<shiro:hasAnyRoles name='888888,100003'>
				<li class="dropdown ">
					...
					<ul class="dropdown-menu">
						...
						<shiro:hasPermission name="/dept/managementuser.shtml">
							<li><a href="<%=basePath%>/dept/managementuser.shtml">部门管理</a></li>
						</shiro:hasPermission>
					</ul>
				</li>
					...
					<li class="dropdown active">
						...
						<ul class="dropdown-menu">
							...
							<shiro:hasPermission name="/role/allocation.shtml">
								<li><a href="<%=basePath%>/role/allocation.shtml">角色分配OnlyJSP</a></li>
							</shiro:hasPermission>
