...
import com.jk.core.shiro.CustomShiroSessionDAO;
import com.jk.user.bo.UserOnlineBo;
/**
 * @author Mr.KangJonney
 * @date   2017年10月10日
 * @remark 用户Session 手动管理
 */
...
public class CustomSessionManager {
	 ...
	 * session status 
	 */
	public static final String SESSION_STATUS ="jk-online-status";
