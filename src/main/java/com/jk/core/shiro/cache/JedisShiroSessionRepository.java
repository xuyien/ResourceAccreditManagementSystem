...
import com.jk.common.utils.SerializeUtil;
import com.jk.core.shiro.session.CustomSessionManager;
import com.jk.core.shiro.session.SessionStatus;
import com.jk.core.shiro.session.ShiroSessionRepository;
/**
 * Session 管理
 * @author jk.com
 *
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    public static final String REDIS_SHIRO_SESSION = "jk-shiro-demo-session:";
    //这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
    public static final String REDIS_SHIRO_ALL = "*jk-shiro-demo-session:*";
